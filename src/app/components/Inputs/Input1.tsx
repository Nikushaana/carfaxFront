...
export default function Input1({
  ...
  return (
    <div
      className={`rounded-[8px] w-full h-[40px] border-[1px]  outline-none px-[5px] flex items-center duration-100 ${
    ...
    >
      ...
      <input
        ...
        value={inputText}
        type={isPassword ? (show ? "text" : "password") : time ? "time" : "text"}
        name={name}
      ...
      {isPassword && (
        <div
          onClick={handleshow}
          className="text-[20px] w-[30px] flex items-center justify-center text-[#010125]"
        >
          {show ? (
